 ...
 * @episode : 
 */
public class Specieslndividual {
	String[] genes; //基因序列
	float distance; //路程
	float fitness; //适应度
	Specieslndividual next;
	float rate;
	
	/**
	 * 初始化
	 */
	public Specieslndividual() {
    ...
    public Specieslndividual clone()
    {   
        Specieslndividual species=new Specieslndividual();
